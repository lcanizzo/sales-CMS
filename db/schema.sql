...
CREATE TABLE IF NOT EXISTS `shopping_db`.`products` (
  ...
  `longDesc` TEXT NULL,
  `thumb` TEXT NULL DEFAULT 'https://cdn.shopify.com/s/files/1/2159/0319/products/160701-O-ZZ999-001_30bb7a46-ec57-452b-8d8e-ebfb7d906d45_480x480.png?v=1501409481',
  `image` TEXT NULL DEFAULT 'https://cdn.shopify.com/s/files/1/2159/0319/products/160701-O-ZZ999-001_30bb7a46-ec57-452b-8d8e-ebfb7d906d45_480x480.png?v=1501409481',
